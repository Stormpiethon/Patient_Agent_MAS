...
def load_patient(patient_id):
    file_path = f"data/{patient_id}.json"

    try:
        with open(file_path, "r", encoding="utf-8") as patient_file:
        ...
        print(f"Error: Patient data file '{file_path}' was not found.")
        return None
    ...
    try:
        ...
        if patient:
            ...
            return {
                ...
                "previous_conditions": patient.get("previous_conditions", [])
            }
